...
#var _Dialogue_Editor = preload("res://addons/open_dialogue_editor/Dialogue_editor.tscn")
...
#	self._Dialog_Editor_Instance = self._Dialog_Editor.instance()
	Dialogue_Editor = preload("res://addons/open_dialogue_editor/Dialogue_editor.tscn").instance()
...
#
#
func _on_Dialogue_Editor_opened(trash_parameter):
	Dialogue_Editor.visible = true
#
#
